...
def adamAsmaca(secret_word):
    ...
    print("6 hakkın olduğunu unutma!")
    print("-----------------------------")
    ...
    while True:
        print("Kalan tahmin sayınız: ",guesses)
        print("Kullanabileceğiniz harfler: ", available_letters)
        
        letter = input("Lütfen bir harf tahmin ediniz: ").lower()
        if not letter.isalpha():
            ...
            warning -= 1
            print("Bu harfi daha öne girdiniz. Lütfen farklı bir harf giriniz. Uyarı hakkınız: ", warning)
            ...
            if letter in secret_word:
                ...
                print("Oops! Bu harf benim kelimemde yok.")
                
        if warning == 0:
            guesses -= 1
            print("Dikkat! Uyarı hakkınız bitti. Bir sonraki uyarınızda tahmin hakkınızdan 1 eksilecek.")
            warning = 3
        if guesses == 0:
